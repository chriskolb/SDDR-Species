################################################################################################
##################### pre-processing and preparation of data of pooled species data ############
################################################################################################
...
# reduce data frame
train <- train[names(train) %in% c(varlist, "newfold", "presence", "spec", "insample")]
train <- train[complete.cases(train),]
test <- test[names(test) %in% c(varlist, "newfold", "presence", "spec", "insample")]
